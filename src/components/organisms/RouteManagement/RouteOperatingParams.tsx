  ...
  return (
    <div className="w-full xl:w-80 flex flex-col gap-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col gap-6">
        ...
        {/* Giờ hoạt động */}
        <div>
          <label className="block text-[11px] font-bold text-gray-500 mb-2 uppercase tracking-wider">Giờ hoạt động</label>
          <div className="flex items-center gap-2">
            <input
              type="text"
        ...
        {/* Tần suất */}
        <div>
          <label className="block text-[11px] font-bold text-gray-500 mb-2 uppercase tracking-wider">Headway (Tần suất)</label>
          <div className="relative">
            <input
              type="number"
              value={route.headwayMinutes}
              onChange={(e) => onUpdate({ headwayMinutes: Number(e.target.value) })}
            ...
            />
            <span className="absolute right-4 top-1/2 -translate-y-1/2 text-xs font-semibold text-gray-400">phút</span>
          </div>
          <p className="text-[10px] text-gray-400 mt-2 leading-relaxed">Thời gian giãn cách giữa các chuyến trong giờ bình thường.</p>
        </div>

        {/* Trạng thái tuyến */}
        <div>
          <label className="block text-[11px] font-bold text-gray-500 mb-2 uppercase tracking-wider">Trạng thái tuyến</label>
          <div className="relative">
            <select
              value={route.status}
      ...
      <div className="bg-blue-50/50 rounded-2xl border border-blue-100 p-5">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-bold text-blue-900 text-sm mb-1">Lưu ý hệ thống</h4>
            <p className="text-xs text-blue-700/80 leading-relaxed">
              Mọi thay đổi về lộ trình hoặc thông số vận hành sẽ trực tiếp ảnh hưởng đến thuật toán tính vé và thời gian ước tính trên ứng dụng Passenger.
            </p>
          </div>
        </div>
      </div>
