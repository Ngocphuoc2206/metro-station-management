...
export default function ShiftStatusCard({ isCheckedIn, onCheckIn, onCheckOut, isLoading }: Props) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm flex flex-col justify-between h-full">
      <div>
        <h2 className="text-base font-bold text-gray-900 mb-6">Trạng thái ca trực</h2>
        <div className="text-center">
          <p className="text-sm font-medium text-gray-500 mb-1">Thời gian hiện tại</p>
