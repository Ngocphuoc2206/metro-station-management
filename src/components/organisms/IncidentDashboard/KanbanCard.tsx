...
export default function KanbanCard({ incident, onDragStart }: Props) {
  ...
  return (
    <div
      ...
      className="bg-white p-4 rounded-xl shadow-sm border border-gray-100/80 cursor-grab active:cursor-grabbing hover:shadow-md transition-shadow relative mb-3 group"
    >
