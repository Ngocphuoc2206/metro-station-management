    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-wrap gap-4 items-end justify-between">
         <div className="flex flex-wrap gap-4 flex-1">
            <div className="w-40">
              <label className="block text-[10px] font-bold text-gray-400 tracking-wider mb-1 uppercase">Nhà ga</label>
              <select 
                value={filters.stationId || "all"}
                onChange={e => onFilterChange({...filters, stationId: e.target.value})}
            ...
            <div className="w-40">
              <label className="block text-[10px] font-bold text-gray-400 tracking-wider mb-1 uppercase">Loại thiết bị</label>
              <select 
                value={filters.deviceType || "all"}
                onChange={e => onFilterChange({...filters, deviceType: e.target.value})}
                className="w-full bg-gray-50 border border-gray-100 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block p-2.5 font-medium outline-none"
              >
            ...
            <div className="w-40">
              <label className="block text-[10px] font-bold text-gray-400 tracking-wider mb-1 uppercase">Mức độ</label>
              <select 
         ...
         <button className="bg-white border border-gray-200 text-gray-700 flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold hover:bg-gray-50 transition-colors">
            <svg className="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" /></svg>
            Bộ lọc khác
         </button>
      </div>
