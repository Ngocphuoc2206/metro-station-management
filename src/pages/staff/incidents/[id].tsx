...
const MOCK_USERS = ["Nguyễn Văn An", "Lê Văn Tuấn", "Trần Minh", "Nguyễn Thu Hà"];
    ...
    return (
      <StaffLayout>
        <div className="text-center py-12">
          <h2 className="text-xl font-bold text-gray-900">Không tìm thấy sự cố</h2>
          <button onClick={() => router.push('/staff/incidents')} className="mt-4 text-blue-600 hover:underline">
            Quay lại danh sách
          </button>
        </div>
      </StaffLayout>
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div>
          <div className="flex items-center text-sm text-gray-500 mb-2">
            <Link href="/staff/incidents" className="hover:text-blue-600 transition-colors">Nhân viên ga</Link>
            <span className="mx-2">›</span>
            <Link href="/staff/incidents" className="hover:text-blue-600 transition-colors">Sự cố</Link>
            <span className="mx-2">›</span>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div>
                  <span className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Thiết bị</span>
                ...
                <div>
                  <span className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Vị trí Nhà Ga</span>
                  <div className="flex items-center gap-2 text-gray-900 font-medium">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div>
                <span className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Mô tả chi tiết</span>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex flex-col gap-3 relative">
              ...
              {attachments.length > 0 && (
                <div className="flex flex-wrap gap-2 mb-2">
                  {attachments.map((file, idx) => (
                    <div key={idx} className="relative group rounded-lg overflow-hidden border border-gray-200 bg-gray-50 flex items-center gap-2 pr-2">
                      ...
                      <span className="text-xs text-gray-600 truncate max-w-[100px] font-medium">{file.name}</span>
                      <button 
              ...
              <div className="flex justify-between items-center mt-1">
                <div className="flex gap-2 text-gray-400">
                  <button onClick={() => fileInputRef.current?.click()} className="p-2 hover:bg-gray-100 hover:text-blue-600 rounded-lg transition-colors cursor-pointer" title="Đính kèm tệp">
                  ...
                  <button onClick={() => fileInputRef.current?.click()} className="p-2 hover:bg-gray-100 hover:text-blue-600 rounded-lg transition-colors cursor-pointer" title="Thêm hình ảnh">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z" clipRule="evenodd" /></svg>
                  </button>
                </div>
                <button
                  onClick={handlePostComment}
                  disabled={actionLoading || (!comment.trim() && attachments.length === 0)}
          ...
          <div className="space-y-6">
              ...
              <div className="p-6 space-y-6">
                <div>
                  ...
                  <select
                    ...
                    disabled={actionLoading || (incident.status !== "Open" && incident.status !== "Assigned" && incident.status !== "InProgress")}
                ...
                <div className="bg-red-50 rounded-xl p-4 border border-red-100 text-center">
                  ...
                  <div className="text-2xl font-black text-red-600">
                    {incident.slaMinutes}p <span className="text-sm font-normal">còn lại</span>
                  </div>
            ...
            <div className="bg-gray-900 rounded-2xl p-6 text-white shadow-sm">
              ...
              <p className="text-sm text-gray-400 mb-4 leading-relaxed">
                Nếu sự cố liên quan đến hạ tầng mạng nhà ga, vui lòng liên hệ trực tiếp phòng kỹ thuật trung tâm.
              </p>
