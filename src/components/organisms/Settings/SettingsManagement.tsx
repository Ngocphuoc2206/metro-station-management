...
export default function SettingsManagement() {
  ...
  const handleSave = async () => {
    ...
    toast.success(
      <div className="flex flex-col gap-1">
        ...
        <span className="text-xs text-gray-600">Cấu hình hệ thống đã được lưu lại.</span>
      </div>,
      { duration: 3000 }
    );
  ...
  return (
    <div className="flex flex-col gap-6 relative pb-28 max-w-4xl">
      ...
      <div>
        <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Cài đặt hệ thống</h1>
      </div>

      {/* Thông tin chung */}
      <SettingsSection title="Thông tin chung" description="Cấu hình các thông tin định danh cơ bản của hệ thống MetroNext.">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div>
            <label className="block text-[11px] font-bold text-gray-900 uppercase tracking-widest mb-2">Tên hệ thống</label>
            <input 
              type="text" 
            ...
            />
            {errors.systemName && <p className="text-xs text-red-500 font-bold mt-2">{errors.systemName}</p>}
          </div>
          <div>
            <label className="block text-[11px] font-bold text-gray-900 uppercase tracking-widest mb-2">Ngôn ngữ mặc định</label>
            <select 
        ...
        <div>
          <label className="block text-[11px] font-bold text-gray-900 uppercase tracking-widest mb-3">Logo đơn vị</label>
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs text-gray-500 font-medium ml-2 relative top-0.5">Khuyên dùng PNG hoặc SVG, tối thiểu 200x200px.</span>
          </div>
        </div>
      </SettingsSection>
      ...
      <SettingsSection title="Tích hợp thanh toán">
        <SettingsToggle 
          ...
          icon={<div className="w-full h-full rounded-full bg-[#A50064] text-white flex items-center justify-center font-black text-[10px]">MoMo</div>}
        />
        <SettingsToggle 
          title="ZaloPay" 
          ...
          icon={<div className="w-full h-full rounded-full bg-[#0068FF] text-white flex items-center justify-center font-black text-[10px]">Zalo</div>}
        />
        <SettingsToggle 
          title="VietQR" 
          ...
          icon={<div className="w-full h-full rounded-full bg-[#E51C24] text-white flex items-center justify-center font-bold text-[10px]">QR</div>}
        />
      </SettingsSection>
